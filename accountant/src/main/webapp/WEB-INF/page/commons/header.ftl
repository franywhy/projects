	<input type="hidden" id="learningCenterUrl" value="${learningCenterUrl}">
	<script src="${STATIC_COMMON}/js/common/jquery.js"></script>
	<script src="${STATIC_COMMON}/js/common/placeholder_IE.js"></script>
	<script src="${STATIC_COMMON}/js/common/com-fn.js"></script>
	<script src="${STATIC_COMMON}/js/common/jquery.cookie.js"></script>
	<script src="${STATIC_COMMON}/js/loginNew.js"></script>
	<#--顶部--> 
	<div class="header-top">
	  <div class="w1200 w-auto-Center clearfix">
	    <div class="header-top-left">
	      <div class="this-left-p">上市公司的教育机构（开元股份：300338） 中国高新技术企业</div></div>
	  </div>
	</div>
	...
	<div class="header-v2">
	  <div class="w1200">
	    <a href="/index">
	      <#--<script type="text/javascript">if (document.domain.indexOf("hengqiedu.cn") >= 0) {
	          document.writeln("<div class=\"logo-2\"></div>");
	        } else {
	          document.writeln("<div class=\"logo\"></div>");
	        }</script>-->
	      <div class="logo"></div>
	    </a>
	    <ul class="nav clearfix-v2">
	      <a href="/index">
	        <li style="color: rgb(51, 51, 51);">首页
	          <i style="overflow: hidden; width: 0px;"></i></li>
	      </a>
	      <a href="javascript:void(0);">
	        <li class="course-nav-a" style="color: rgb(51, 51, 51);">课程
	          <em style="display: none;"></em></li>
	      </a>
	      <a href="http://tiku.hqjy.com/">
	        <li style="color: rgb(51, 51, 51);">题库
	          <i style="overflow: hidden; width: 0px;"></i></li>
	      </a>
	      <a href="/shixun/index">
	        <li style="color: rgb(51, 51, 51);">实训
	          <i style="overflow: hidden; width: 0px;"></i></li>
	      </a>
	      <a href="/school">
	        <li style="color: rgb(51, 51, 51);">校区
	          <i style="overflow: hidden; width: 0px;"></i></li>
	      </a>
	      <a href="javascript:;" id="learning">
	        <li style="color: rgb(51, 51, 51);">学习中心
	          <i style="width: 0px;"></i></li>
	      </a>
				<a href="http://ces.hqjy.com/" target="_blank">
	        <li style="color: rgb(51, 51, 51);">继续教育
	          <i style="overflow: hidden; width: 0px;"></i></li>
	      </a>
				<a href="http://www.hengqijy.com/" target="_blank">
	        <li style="color: rgb(51, 51, 51);">关于我们
	          <i style="overflow: hidden; width: 0px;"></i></li>
	      </a>
	    </ul>
	    <ul class="register clearfix-v2 none" id="registerNoDiv" style="display: block;">
	      <li class="btn-login">登录</li>
	      <li class="btn-reget">注册</li>
	    </ul>
	    <div class="register-yes-out right" id="registerYesDiv" style="display:none">
		  <div class="top-self-box">
		    <div class="self-box-t clearfix">
		      <div class="self-box-t-p" id="headUserName"></div>
		      <div class="self-box-t-i">
		        <img id="headPhoto" style="border-radius: 50%;" src="${STATIC_COMMON}/images/icon/default-photo.png">
		      </div>
		    </div>
		    
		    <div class="self-box-main">
		      <a href="/user/logout" class="self-box-main-dd self-box-main-dd-last">注销</a></div>
		  </div>
		</div>
	  </div>
	  <div class="course-xiala" style="display: none;">
	    <div class="w1200 clearfix-v2 relative">
	      <ul class="div-left left">
      		<#list firstLevel as first>
      			<#if first_index == 0>
      				<li class="act">${first.typename}</li>
      			<#else>
      				<li>${first.typename}</li>
      			</#if>
      		</#list>
          </ul>
          <#list firstLevel as first>
          	<#if first_index == 0>
  				<dl class="div-right right ">
			        ...
			        <dd class="clearfix" style="width: 800px;">
			          <div class="t-dd-box" style="">
			          	<#list secondLevel as second>
			          		<#if first.typeid == second.fatherid>
			          			<a href="${second.qqlink}">
					              <div class="t-dd" style="animation: fadeInRight 0.6s 0s forwards;">
					                <ul>
					                  <div class="t-h1">
					                    <img src="${imageDomain}${second.pic}" /></div>
					                  <div class="t-h2">${second.typename}</div></ul>
					              </div>
					            </a>
			          		</#if>
			          	</#list>
  			...
  			<#else>
  				<dl class="div-right right none">
			        <dt class="relative">选择班型：</dt>
			        <dd class="clearfix" style="width: 400px;">
			          <div class="t-dd-box" style="">
				          <#list secondLevel as second>
				          		<#if first.typeid == second.fatherid>
				          			<a href="${second.qqlink}">
	...
	<#--登陆黑背景-->
	<div class="mask-login" style="display: none;"></div>
	<#--登陆加注册-->
	<div class="login-box tologin" style="display: none;">
	  ...
	  <div class="login-main">
	    <div class="login-title-tab clearfix">
	      <div class="login-tab-title login-tab-title-left">登录</div>
	      <div class="login-tab-title act">注册</div></div>
	    <div class="login-title-main clearfix">
	      <div class="login-tab-main">
	        ...
	        <a href="javascript:;" class="disremember disrememberpw">忘记密码？</a></div>
	      <div class="login-tab-main" style="display: none;">
	        ...
	        <div class="input-register-box clearfix">
	          ...
	          <a id="recode" class="recode" onclick="javascript:document.getElementById('imgCode').src='/user/verifyCode?id='+Math.random();" style="cursor: hand;">换一个</a>
	        ...
	        <div class="input-register-box">
	          ...
	          <div class="input-btn" id="getCode">获取验证码</div></div>
	        ...
	        <div class="cast-p">
	          ...
	          <span class="checkbox-cast-p">
	            <label for="checkbox-cast">同意恒企教育</label>《
	            <b>服务条款</b>》</span>
	        </div>
	        <div class="input-btn register">立即注册</div>
	        <a href="http://looyuoms7811.looyu.com/chat/chat/p.do?_server=0&amp;c=20001784&amp;f=10068290&amp;g=10066933" target="_blank" class="disremember cantregister">无法注册？</a></div>
	    </div>
	  </div>
	</div>
	    ...
	    <div class="login-title-main clearfix">
	      <div class="login-tab-main">
	        ...
	        <div class="input-register-box clearfix">
	          ...
	          <a id="recode1" class="recode" onclick="javascript:document.getElementById('imgCode1').src='/user/verifyCode?id='+Math.random();" style="cursor: hand;">换一个</a>
	        ...
	        <div class="input-register-box">
	          ...
	          <div class="input-btn" id="getCode1">获取验证码</div></div>
	        ...
	        <a href="javascipt:;" class="disremember cantregister" style="visibility: hidden;">无法注册？</a></div>
	    </div>
	  </div>
	</div>
	...
	<div class="login-box login-txt" style="display: none;">
	  <div class="close"></div>
	  <div class="red-alert">您的密码错误</div>
	  <div class="login-main">
	    <div class="login-txt-title">恒企教育服务条款</div>
	    <div class="login-txt-p  login-txt-p-big">
	      <b>一、注册账号服务条款的确认和接受</b>
	    </div>
	    ...
	    <div class="login-txt-p">
	      <b>5、用户帐号和密码仅由初始申请注册人使用，用户不得将自己用户账户或密码有偿或无偿以转让、出借、授权等方式提供给第三人操作和使用, 否则用户应当自行承担因违反此要求而遭致的任何损失。违反本项约定的，恒企并保留收回账号的权利。若因违反本约定对他人造成损害的，用户应与实际使用人承担连带赔偿责任，同时恒企保留追究用户违约责任的权利。</b>
	    </div>
	    ...
	    <div class="login-txt-p">7、恒企
	      <b>建议用户应当使用本人名义为用户账户充值或行使付款行为。若用户存在使用第三人的名义进行充值或付款，或委托第三人代为充值或付款之行为的，则以上行为被视作本人的行为，若由于该第三人行为导致充值或付款行为失败或成功后又被撤销的，均被认为是用户本人真实意思的表示和用户本人实施的行为，由此所造成的一切法律后果均由用户自行承担。</b>
	    </div>
	    <div class="login-txt-p  login-txt-p-big">
	      <b>四、使用规则</b>
	    </div>
	    ...
	    <div class="login-txt-p">
	      <b>2、为了更好地为用户提供全面服务，用户同意恒企将用户注册资料及使用信息提供恒企关联公司使用。恒企保证前述关联公司同等级地严格遵循本服务条款第六条第1款之隐私保护责任。</b>
	    </div>
	    <div class="login-txt-p">
	      <b>3、用户同意：恒企或恒企运营商的关联公司在必要时有权根据用户注册时或接受服务时所提供的联系信息（包括但不限于电子邮件地址、联系电话、联系地址、即时聊天工具账号等），通过电子邮件、电话、短信、邮寄、即时聊天、弹出页面等方式向用户发送如下信息：</b>
	    </div>
	    <div class="login-txt-p">
	      <b>（1）各类重要通知信息，可能包括但不限于订单、交易单、修改密码提示等重要信息。此类信息可能对用户的权利义务产生重大的有利或不利影响，用户务必及时关注。</b>
	    </div>
	    <div class="login-txt-p">
	      <b>（2）商品和服务广告、促销优惠等商业性信息。若用户不愿意接收此类信息，则可通过告知（口头或书面）的方式通知恒企或恒企运营商的关联公司取消发送，亦可通过恒企或恒企运营商关联公司所提供的相应退订功能（若有）进行退订。</b>
	    </div>
	    <div class="login-txt-p login-txt-p-big">
	      <b>七、服务条款的用途、更新和效力</b>
	    </div>
	    <div class="login-txt-p">
	      <b>1、本服务条款用以规范用户使用恒企提供的服务,本服务条款与恒企社区行为准则构成完整的服务条款。</b>
	    </div>
	    <div class="login-txt-p">
	      <b>2、鉴于国家法律法规</b>不时变化及恒企运营之需要，恒企有权对本服务条款不时地进行修改，修改后的服务条款一旦被公布于恒企上即告生效，并替代原来的服务条款。用户有义务不时关注并阅读最新版的服务条款及网站公告。如用户不同意更新后的服务条款，则应立即停止接受恒企依据本服务条款提供的服务；若用户继续使用恒企提供的服务的，即视为同意更新后的服务条款。如果本服务条款中任何一条被视为废止、无效或因任何理由不可执行，该条应视为可分的且并不影响任何其余条款的有效性和可执行性。</div>
	    <div class="iagree-btn">我同意</div></div>
	</div>
	
	<#--<script type="text/javascript">
	    $(function () {
	        var isLogined = 'False'.toLowerCase();
	        if (isLogined == 'true') {
	            $('.header-v2 .register-yes-out').show();
	        }
	        else {
	            $('.header-v2 .register').show();
	        }
	    });
	</script>-->