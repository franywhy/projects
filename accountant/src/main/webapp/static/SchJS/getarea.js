$(function () {
    var citySelector = function () {
        ...
        var jsonProvince = "/SchJS/json-array-of-province.js";
        var jsonCity = "/SchJS/json-array-of-city.js";
        var jsonDistrict = "/SchJS/json-array-of-district.js";
                ...
                if (hasDistrict) {
                    city.change(function () {
                        ...
                        if ($(this).val() != "0") {
                            ...
                            $("#citytext").val($(this).find("option:selected").text());
                        }
                    });
                    province.change(function () {
                        city.change();
