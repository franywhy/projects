	...
	$.fn.kinMaxShow = function(user_options){
			...
			var default_options = {
						...
						button:{
								...
								normal:{width:'17px',height:'16px',lineHeight:'16px',left:"45%",bottom:'10px',fnotSize:'0',background:'url(./images/05.png) no-repeat',marginRight:'8px',float:'left'},
								//当前 按钮样式
								focus:{background:'url(./images/11.png) no-repeat'}
							},
			...
			var btnCenter = $("#banner div").length*20/2;
