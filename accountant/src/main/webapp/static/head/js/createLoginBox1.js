	        ...
	        <div class="ul">\
	            ...
	            <div class="form-table userLogin">\
	                <div class="user-login-box">\
	                    ...
	                    <div class="select">\
	                        <span class="s-btn-forget"><a href="http://me.kjcity.com/getpassword.html" target="_blank">忘记密码?</a></span>\
	                ...
	                <div class="form-table userRegister">\
	                    ...
	                    <button class="bitme-btn  next-btn active">下一步</button><button style="display:none;" class="bitme-btn  next-btn1 active">立即注册</button>\
	                </div>\
	            </div>\
	        </div>\
	    </div>\
