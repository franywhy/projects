...
import com.hq.answerapi.config.props.CaptchaProperties;
import com.hq.answerapi.config.props.LocalConfigProperties;
import com.hq.answerapi.pojo.MobileNo;
...
public class SMSController extends AbstractRestController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "captchaCode", value = "验证码", required = false, dataType = "String", paramType = "query"),
