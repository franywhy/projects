...
class BannerCourseController extends BaseController {
	...
	def add(HttpServletRequest req){
		...
		table().save(banner);
		Crud.opLog("banner_course",[save:banner["_id"]]);
		return OK();
	}
	...
	def edit(HttpServletRequest req){
		...
		Crud.opLog("banner_course",[edit:id]);
		return OK();
	}
	...
	def del(HttpServletRequest req){
		...
		Crud.opLog("banner_course",[del:id]);
		return OK();
	}
}
