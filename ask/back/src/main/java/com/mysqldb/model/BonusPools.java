...
public class BonusPools implements Serializable {
  ...
  public java.lang.Integer get_id(){
	...
	@OneToMany(fetch = FetchType.LAZY, mappedBy = "bonusPools", cascade=CascadeType.ALL)
	public Set<Bunus> getBonusList() {
		return BonusList;
	}

	public void setBonusList(Set<Bunus> bonusList) {
		BonusList = bonusList;
	}
}
