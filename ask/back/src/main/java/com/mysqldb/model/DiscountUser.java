...
public class DiscountUser implements Serializable {
	...
	/**
	 * Author name@mail.com
	 * 设置 是否已使用 0.否 1.是 的属性值
	 *		
	 * @param isUse :  是否已使用 0.否 1.是 
	 */
	 ...
	 * 设置 优惠券有效起始日期 的属性值
	 *		
	 * @param discountStartTime :  优惠券有效起始日期 
	 */
	...
	public String toString(){		
		return "{ _name=DiscountUser" + ",id=" + id +",discountId=" + discountId +",discountCode=" + discountCode +",phone=" + phone +",getTime=" + getTime +",isUse=" + isUse +",useTime=" + useTime +",discountEndTime=" + discountEndTime +",discountStartTime=" + discountStartTime + "}";
	}
