...
!function ($) {
    ...
    BootstrapTable.prototype.getData = function () {
        return (this.searchText || !$.isEmptyObject(this.filterColumns)) ? ($.isArray(this.data)?this.data:this.data.data) : ($.isArray(this.options.data)?this.data:this.options.data.data);
    };
