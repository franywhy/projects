...
$b.baseDomain.nocdnDomain = 'localhost:83'
# $b.adminDomain =     #依然使用原来的空间 管理站
# $b.appDomain  				#依然使用原来的空间 服务器
$b.wwwDomain.nocdnDomain = 'localhost:80'
$b.assetDomain.nocdnDomain = 'asset.izhubo.com'
$b.imgDomain.nocdnDomain = 'img.izhubo.com'
$b.rootDomain.nocdnDomain = 'localhost:80'
