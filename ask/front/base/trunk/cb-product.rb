...
$b.baseDomain.nocdnDomain = 'lib.xuelxuew.com'
# $b.adminDomain =     #依然使用原来的空间 管理站
# $b.appDomain  				#依然使用原来的空间 服务器
$b.wwwDomain.nocdnDomain = 'www.xuelxuew.com'
$b.assetDomain.nocdnDomain = 'asset.xuelxuew.com'
$b.imgDomain.nocdnDomain = 'img.xuelxuew.com'
$b.rootDomain.nocdnDomain = 'lib.xuelxuew.com'
