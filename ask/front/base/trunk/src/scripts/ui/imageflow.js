...
function ImageFlow ()
{
	...
	this.defaults =
	{
		animationSpeed:     50,             /* 动画轮播速度 50ms默认 */
		aspectRatio:        1.964,          /* Aspect ratio of the ImageFlow container (width divided by height) */
		buttons:            false,          /* 是否显示按钮 */
	...
	this.refresh = function()
	{
		...
		my.ImageFlowDiv.style.height = 200 + 'px';

		/* Change images div properties */
		my.imagesDiv.style.height =  200 + 'px'; 
		
		/* Change images div properties */
		my.navigationDiv.style.height =  200 + 'px'; 
		...
		for (var index = 0; index < my.max; index++)
		{
			...
			if(my.imageScaling)
			{
				...
				else
				{
					...
					var newImageTop = 0 + ((newImageH / (my.reflectionP + 1)) * my.reflectionP);
