 ...
 */
@Rest
class WXAppPayController extends PayBaseController{
	...
	public Object factoryPayHtml(Orders order) {
		...
		//支付data
		PayReqData data = new PayReqData(body, detail, attach, outTradeNo, totalFee, spBillCreateIP, notify_url , opend_id,Configure.TRADE_TYPE_APP);
...
//		println "===============checkIsSignValidFromResponseString:" + Signature.checkIsSignValidFromResponseString(result);
		...
		//签名
		map["sign"] = Signature.getSign(map);
