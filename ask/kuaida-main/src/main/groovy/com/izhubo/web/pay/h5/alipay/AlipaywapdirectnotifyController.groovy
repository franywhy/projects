...
import com.izhubo.web.pay.h5.alipay.util.AlipayNotify
/**
 * 支付宝h5 异步回调
 */
@Rest
@RequestMapping("/alipaywapdirectnotify")
class AlipaywapdirectnotifyController extends PayNotityBaseController {
