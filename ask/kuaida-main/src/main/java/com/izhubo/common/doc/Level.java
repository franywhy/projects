...
public class Level {
    ...
    static {
        ...
        for(int i=1;i<xingguang_max_level;i++){
            xingguang_levels[i] = xingguang_levels[i-1] + deltaCoin(i);
        }
    }
...
//http://192.168.1.181/redmine/projects/xinyuan/wiki/%E6%98%9F%E6%84%BFAPI%E6%96%87%E6%A1%A3#消费星级
    ...
    public static void main(String[] args) {
      ...
      /*  System.out.println(starLevel(898988));*/
       ...
       System.out.println(starLevel(257000000));
