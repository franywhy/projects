...
public  abstract class KeyUtils {
    ...
    public static String kuaijiTip(int userid) {
        return "kuaijiTip:"+userid;
    }

    public static String zikaoTip(int userid){
        return "zikaoTip:"+userid;
    }
    ...
    public static class TOPICES{
    	...
    	public static final String TOPICESTIMELIMIT = "topices_timelimit:";
    	public static final String TOPICES_PJ_REMIND = "topices_pj_remind:";
    	public static final String TOPICESLIST_V1 = "_v";
    	public static final String MID_TOPICES_MSG_REMIND = "topices_remind";

    	/*********   提交问题--自考   **********/
        public static final String TOPICES_ZIKAO = "topicesZikao:";
        public static final String TOPICESLIST_ZIKAO = "topiceQueueZikao";

    	//提问未抢答失效的毫秒(30分钟)
        //提问未抢答失效的毫秒18/3/20改为24小时(24小时)
    	public static final Long TPICES_INDUSTRYS_TIME = 1 * 24 * 3600 * 1000L;
        //自考提问未抢答失效的毫秒(24小时)
        public static final Long TPICES_INDUSTRYS_TIME_ZIKAO = 1 * 24 * 3600 * 1000L;

    	//public static final Long TPICES_INDUSTRYS_TIME = 30000L;
    	//提问未抢答失效的小时
//    	public static final Long TPICES_INDUSTRYS_TIME = 1L;
    	//教师端-问题剩余临界抢答时间的毫秒
    	public static final Long TPICES_TIME_LIMIT_TEXT = TPICES_INDUSTRYS_TIME - 180000L;
//    	public static final Long TPICES_TIME_LIMIT_TEXT = 3600000 * TPICES_INDUSTRYS_TIME - 180000L;
    	
    	public static String tpicesIndustrys(String topic_id){
    		return TOPICES + topic_id;
    	}

        public static String tpicesIndustrysZikao(String topic_id){
            return TOPICES_ZIKAO + topic_id;
        }
    	...
    	/** 提问时间限制 */
    	public static final String TOPICS_STUDENT_LIMIT_TIME = TOPICESTIMELIMIT + "student:";
    	public static final Long TOPIC_STUDENT_LIMIT_TIME = 1L;
    	public static String topicsStudentKey(Integer user_id){
    		return TOPICS_STUDENT_LIMIT_TIME + user_id;
    	}
    	/** 抢答时间限制 */
    	public static final String TOPICS_TEACHER_LIMIT_TIME = TOPICESTIMELIMIT + "teacher:";
    	public static final Long TOPIC_TEACHER_LIMIT_TIME = 1L;
    	public static String topicsTeacherKey(Integer user_id){
    		return TOPICS_STUDENT_LIMIT_TIME + user_id;
    	}
    	
    	
    	/** 问题评价提醒 */
    	public static final Long TOPIC_PJ_REMIND_LIMIT_TIME = 1L;
    	public static String topicsPJRemindKey(String topicid){
    		return TOPICES_PJ_REMIND + topicid;
    	}
    ...
    public static class BUNUS{
    	
    	public static final String BUNUS = "bunus:";
    	public static final String BUNUS_OPEN_TIMEOUT_KEY = BUNUS + "time_out:";
    	public static final Long BUNUS_TIME = 24L;
    	public static String bunusTimeOutKey(String topic_id){
    		return BUNUS_OPEN_TIMEOUT_KEY +topic_id;
    	}
    	public static String bunusTimeOutVal(String topic_id , Integer teacher_id){
    		return topic_id + "-" + teacher_id;
    	}
    ...
    public static class COMMODITYS {
    	  ...
    	  public static final Long COMMODITY_SCHOOL_PRICE_TIME = 5L;
