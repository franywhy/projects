...
public class CountMiddleLiveSchedule extends QuartzJobBean {
	...
	private String sync_url = "live_data/count_middle_course_live";

	private static Logger logger = LoggerFactory
			.getLogger(CountMiddleLiveSchedule.class);

	/* 业务实现 */
	public void work() {
		logger.info("定时同步开始，开始生成中级职称学员的观看直播数据：" + new Date());
		try {
