...
public class MiddleCourseSchedule extends QuartzJobBean {
	...
	private String sync_url = "learningcenter/NCMiddleSignBuild";

	private static Logger logger = LoggerFactory
			.getLogger(MiddleCourseSchedule.class);

	/* 业务实现 */
	public void work() {
		logger.info("定时同步开始，开始生成中级职称排课计划：" + new Date());
		try {
