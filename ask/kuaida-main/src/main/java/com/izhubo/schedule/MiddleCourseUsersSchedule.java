...
public class MiddleCourseUsersSchedule extends QuartzJobBean {
	...
	private String sync_url = "learningcenter/NCMiddleSignUsersBuild";

	private static Logger logger = LoggerFactory
			.getLogger(MiddleCourseUsersSchedule.class);

	/* 业务实现 */
	public void work() {
		logger.info("定时同步开始，开始生成中级职称学员列表：" + new Date());
		try {
