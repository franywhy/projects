...
public class BonusTypeMain implements Serializable {
  ...
  public java.lang.Integer get_id(){
	 ...
	 */
	@Column(name = "YEAR_MONTH",columnDefinition = "VARCHAR")
	...
	public String toString(){		
		return "{ _name=BonusTypeMain" + ",id=" + id +",mainTemplateName=" + mainTemplateName +",allMoney=" + allMoney +",yearMonth=" + yearMonth +",remark=" + remark +",auditFlag=" + auditFlag +",auditUserId=" + auditUserId +",createUserId=" + createUserId +",timestamp=" + timestamp +",updateDate=" + updateDate +",updateUserId=" + updateUserId +",uploadDate=" + uploadDate +",uploadFlag=" + uploadFlag +",uploadUserId=" + uploadUserId + "}";
	}
