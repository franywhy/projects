...
public class Bunus implements Serializable {
	...
	public String toString(){		
		return "{ _name=Bunus" + ",id=" + id +",mlevel=" + mlevel +",mmoney=" + mmoney +",mtemplate=" + mtemplate +",topicId=" + topicId +",uniqueMark=" + uniqueMark +",userId=" + userId +",isOpen=" + isOpen +",openTime=" + openTime +",mweight=" + mweight +",yearMon=" + yearMon +",lotteryTime=" + lotteryTime +",mtimestamp=" + mtimestamp  +",vweight=" + vweight + "}";
	}
