 ...
 * Date: 2016-04-12 15:40:28
 */
@Entity
@Table(name = "user_finance_detail")
@org.hibernate.annotations.Table(appliesTo = "user_finance_detail", comment = "user_finance_detail")
public class UserFinanceDetail implements Serializable {
	private static final long serialVersionUID = 1L;

	/**
	 * user_finance_detail
	 */
	public static final String REF="UserFinanceDetail";
	...
	public String toString(){		
		return "{ _name=UserFinanceDetail" + ",id=" + id +",mmoney=" + mmoney +",mmoneyDetail=" + mmoneyDetail +",mmoneyType=" + mmoneyType +",userId=" + userId +",userNickname=" + userNickname +",createTime=" + createTime + "}";
	}
