...
public class Upomp_Pay_Info {
     ...
     */
    // 商户名称，商户可以自行修改
    public static String merchantName = "上海水渡石信息技术有限公司";
    ...
    // 订单描述：对于该订单的描述
    public static String merchantOrderDesc = "秀场充值充值";
    // 订单超时时间:建议传""。
    public static String transTimeout = "";
    // 该URL与payurl相同，填写为商户服务器地址。
    public static String backEndUrl = "http://ttapi.app100699141.twsapp.com/unionpay/pay_callback";
    //签名原串
