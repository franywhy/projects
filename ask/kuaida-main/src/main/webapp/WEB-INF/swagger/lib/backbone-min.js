...
(function(t, e) {
	...
	i.extend(g.prototype, u, {
				...
				set : function(t, e) {
					...
					var v = i.isString(this.comparator)
							? this.comparator
							: null;
					var g = [], y = [], _ = {};
				...
				get : function(t) {
					if (t == null)
						return void 0;
					return this._byId[t] || this._byId[t.id]
							|| this._byId[t.cid]
				},
				at : function(t) {
	...
	var _ = ["forEach", "each", "map", "collect", "reduce", "foldl", "inject",
			...
			"indexOf", "shuffle", "lastIndexOf", "isEmpty", "chain", "sample"];
	i.each(_, function(t) {
	...
	i.extend(N.prototype, u, {
		...
		stop : function() {
			e.$(window).off("popstate", this.checkUrl).off("hashchange",
					this.checkUrl);
