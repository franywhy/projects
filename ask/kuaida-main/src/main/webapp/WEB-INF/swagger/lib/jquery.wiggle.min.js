/*
 * jQuery Wiggle Author: WonderGroup, Jordan Thomas URL:
 * http://labs.wondergroup.com/demos/mini-ui/index.html License: MIT
...
jQuery.fn.wiggle = function(o) {
	...
	return this.each(function() {
		var cache = this;
		var wrap = jQuery(this).wrap('<div class="wiggle-wrap"></div>').css(
				"position", "relative");
		var calls = 0;
