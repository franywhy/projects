package com.izhubo.rest.common.util.http;
...
//                    });
    ...
    public static String get(String url,Map<String,String> HEADERS,Charset forceCharset,String proxyUrl,int proxyPort)throws IOException{
        HttpGet get = new HttpGet(url);
        
        HttpHost proxy = new HttpHost(proxyUrl,proxyPort, null);  
        get.getParams().setParameter(ConnRouteParams.DEFAULT_PROXY, proxy);
        return execute(get,HEADERS,forceCharset);
    }
