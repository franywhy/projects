...
import com.izhubo.rest.web.spring.SessionInterceptor;
...
//
    ...
    public static void opLog(String type,Object data){
        ...
        obj.put(_id,tmp);
        obj.put("type",type);
        obj.put("session",sessionInterceptor == null ? null : sessionInterceptor.getSession());
        obj.put("data",data);
