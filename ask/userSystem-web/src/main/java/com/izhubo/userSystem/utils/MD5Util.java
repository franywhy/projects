...
public class MD5Util {
	 ...
	 * @throws IOException
	 */
	public static String getFileMD5String(String fileString) throws IOException {
	...
	public static void main(String[] args) throws IOException {
		...
		File file = new File("E:/demo/123.txt");
		String md5 = getFileMD5String(file);

		// 文件名不同，内容相同；
		File file2 = new File("E:/demo/123 - 副本.txt");
		String md52 = getFileMD5String(file2);

		// 文件名不同，内容不同；
		File file3 = new File("E:/demo/123 - 副本 (2).txt");
