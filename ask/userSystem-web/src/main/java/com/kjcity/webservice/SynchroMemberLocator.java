...
public class SynchroMemberLocator extends org.apache.axis.client.Service implements com.kjcity.webservice.SynchroMember {
    ...
    private java.lang.String SynchroMemberSoap_address =AppProperties.get("webservice.domain") +"/WebService/SynchroMember.asmx";
    ...
    public com.kjcity.webservice.SynchroMemberSoap getSynchroMemberSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.kjcity.webservice.SynchroMemberSoap getSynchroMemberSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.kjcity.webservice.SynchroMemberSoapStub _stub = new com.kjcity.webservice.SynchroMemberSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.kjcity.webservice.SynchroMemberSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.kjcity.webservice.SynchroMemberSoapStub _stub = new com.kjcity.webservice.SynchroMemberSoapStub(new java.net.URL(SynchroMemberSoap_address), this);
                _stub.setPortName(getSynchroMemberSoapWSDDServiceName());
                return _stub;
            }
        }
