...
public class SynchroMemberLocator extends org.apache.axis.client.Service implements com.usercenter.webservice.SynchroMember {
    ...
    private java.lang.String SynchroMemberSoap_address =AppProperties.get("webservice.domainssotest") +"/WebService/SynchroMember.asmx";
    ...
    public com.usercenter.webservice.SynchroMemberSoap getSynchroMemberSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.usercenter.webservice.SynchroMemberSoap getSynchroMemberSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.usercenter.webservice.SynchroMemberSoapStub _stub = new com.usercenter.webservice.SynchroMemberSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.usercenter.webservice.SynchroMemberSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.usercenter.webservice.SynchroMemberSoapStub _stub = new com.usercenter.webservice.SynchroMemberSoapStub(new java.net.URL(SynchroMemberSoap_address), this);
                _stub.setPortName(getSynchroMemberSoapWSDDServiceName());
                return _stub;
            }
        }
