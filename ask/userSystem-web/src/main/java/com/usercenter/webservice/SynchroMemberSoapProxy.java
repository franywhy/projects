...
public class SynchroMemberSoapProxy implements com.usercenter.webservice.SynchroMemberSoap {
  private String _endpoint = null;
  private com.usercenter.webservice.SynchroMemberSoap synchroMemberSoap = null;
  ...
  private void _initSynchroMemberSoapProxy() {
    try {
      synchroMemberSoap = (new com.usercenter.webservice.SynchroMemberLocator()).getSynchroMemberSoap();
  ...
  public com.usercenter.webservice.SynchroMemberSoap getSynchroMemberSoap() {
    if (synchroMemberSoap == null)
      _initSynchroMemberSoapProxy();
