...
//    NOT_EXTENDED(510, "Not Extended"),
    ...
    ADAPTIVE_LEARNING_NOT_COURSES(11101,"自适应平台不存在课程"), 
	ADAPTIVE_LEARNING_PARAMETER_ERROR(11102,"自适平台应参数错误"), 
	ADAPTIVE_LEARNING_NOT_MASTERED_KNOWLEDGE_EMPTY(11103,"自适平台未掌握知识点为空"),

    ANSWER_NOT_PERMISSION_LOGIN_EMPLOYEES_APP(22201,"您没有权限登陆恒企员工APP"),
    ANSWER_ACCOUNT_HAS_BEEN_BANNED_DUE_TO_VIOLATION(22202,"您的账号因违规已被封禁"),
    ANSWER_PASSWORD_IS_TOO_SIMPLE(22203,"密码格式非法，请重置再登陆");
      // 22204 已经被使用，跳过
