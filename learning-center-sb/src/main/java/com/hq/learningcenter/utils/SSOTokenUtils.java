...
public class SSOTokenUtils {
	...
	@Value("")
	private void setUrl(){
		userInfoUrl = ssoConfig.getSsoUserinfoUrl();
	}
	
	/** token detail url*/
    private static String tokenDetailUrl = "";
	@Value("")
	private void setDetailUrl(){
		tokenDetailUrl = ssoConfig.getSsoUsertokendetailUrl();
	}
	
	/** user mobile url*/
    private static String userMobileUrl = "";
	@Value("")
	private void setMobileUrl(){
		userMobileUrl = ssoConfig.getSsoUsermobilenoUrl();
	}
