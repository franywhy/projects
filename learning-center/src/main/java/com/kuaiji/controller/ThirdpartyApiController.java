...
import com.kuaiji.pojo.ZegoRequestPOJO;
import com.kuaiji.pojo.ZegoResponsePOJO;
...
//		Integer appid = zegoRequest.getAppid();
		...
		if(zkey.equals("simulationtoken123")){
			...
			String zjson2 = com.kuaiji.utils.JSONUtil.beanToJson(zegoTokenObj2);
			//保存一个redis
		...
		Map<String, Object> Rmap = com.kuaiji.utils.JSONUtil.jsonToMap(ZegoToken);
