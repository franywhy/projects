...
import com.kuaiji.pojo.ZegoTokenObjPOJO;
import com.kuaiji.utils.ProduceToken;
...
public class LiveServiceImpl implements LiveService {
	...
	@Value("#{application['pom.gensee.ctx']}")
	...
	private void setCCReplay(String ccReplay){
		CC_REPLAY = ccReplay;
	}
	
	private static Long K_TIMEOUT = 0L;
	@Value("#{application['pom.gensee.k.timeout']}")
	private void setLiveUrl(Long kTimeOut){
		K_TIMEOUT = kTimeOut;
	}
	
	private static String WHITE_K = "";
	@Value("#{application['pom.gensee.k.white']}")
	private void setLiveUrl(String whiteK){
		WHITE_K = whiteK;
	}
	...
	public Map<String, Object> getZegoLiveUrl(String classplanLiveId, UserInfoPOJO user, String businessId) {
		try{
			...
			String zjson = com.kuaiji.utils.JSONUtil.beanToJson(zegoTokenObj);
