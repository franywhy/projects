...
<body class="bg-f2">
            ...
            <div class="container-right">
            	<div class="attendance-title">
                	<div class="nav" id="nav">
                        <ul>
                            <li class="active"><a href="javascript:">休学</a></li>
						...
						<#if data[0]??>
                        	<#list 0..(data!?size-1) as i>
								<tr>
		                            ...
		                            <td>${data[i].expectEndTime?string("yyyy-MM-dd")}</td>
	        ...
	        <div class="att-content-bar">
	        	<div class="att-content">
	                ...
	                <form class="att-form" id="form">
	                    ...
	                    <div class="att-label" id="stopTime">
	                    ...
	                    <div class="att-label" id="reopenTime">
	                    ...
	                    <div class="att-label" id="cause">
	                        <span class="input-title">休学原因</span>
	                    ...
	                    <div class="att-label" style="display:none;" id="promptText">
	                    	<div class="color-ff9000 text-left">
	                    		...
	                    		<span class="text-se">请输入完整的休学申请内容，不能有为空项。</span>
	                    	</div>
	                    </div>
	                    <div class="att-label">
    ...
    <script type="text/javascript" src="/resources/compress/js/studycenter/attendance.js"></script>
</body>
</html>
</#compress>
