...
<body class="bg-f2">
            	...
            	<div class="attendance-title">
                	<div class="nav" id="nav">
                        <ul>
                            ...
                            <li class="active"><a href="javascript:">报考</a></li>
                            <li><a href="/learningCenter/web/courseAbnormalAbandonExamList">弃考</a></li>
                            <li><a href="/learningCenter/web/courseAbnormalFreeAssessmentList">免考核</a></li>
                        </ul>
                    </div>
                    <div class="fr">
                ...
                <div class="record-table">
                	<table>
                    	<tr>
                            ...
                            <th class="min-w-150px">报考课程</th>
                            <th class="min-w-110px">报考省份</th>
                            <th class="min-w-110px">报考时间</th>
                            <th class="min-w-150px">报考登记号</th>
						...
						<#if data[0]??>
                        	<#list 0..(data!?size-1) as i>
								<tr>
		                            ...
		                            <td>${data[i].registerProinve}</td>
		                            <td>${data[i].scheduleDate}</td>
		                            <#if data[i].registerPk??>
		                        		<td>${data[i].registerPk}</td>
		                        	<#else>
		                        		<td>无</td>
		                        	</#if>
		                            <#if data[i].status == 0>
	                ...
	                <form class="att-form" id="form">
	                    ...
	                    <div class="select-bar">
	                        <div class="att-label mb-0px" id="course">
	                            <span class="input-title">报考课程</span>
	                            <input type="text" class="att-input radius-5px" readonly placeholder="" value="">
	                            <span class="solid-down-arrow-icon-p">
	                            	<span class="solid-down-arrow-icon bg-cover"></span>
	                            </span>
	                    ...
	                    <div class="select-bar">
	                    	<div class="att-label mb-0px" id="province">
	                        	<span class="input-title">报考省份</span>
	                        	<input type="text" class="att-input radius-5px" readonly placeholder="" value="" maxlength="10">
	                        	<span class="solid-down-arrow-icon-p">
	                        		<span class="solid-down-arrow-icon bg-cover"></span>
	                        	</span>
	                        	<div class="sign">
	                    	...
	                    	<div class="select radius-5px" id="selectList3">
	                    		<#if areaData[0]??>
		                        	<#list 0..(areaData!?size-1) as i>
			                        	<div class="select-list" data-id="${areaData[i].id}">${areaData[i].areaName}</div>
			                        </#list>
			                    </#if>
	                    	</div>
	                    </div>
	                    <div class="select-bar">
	                    	<div class="att-label mb-0px" id="time">
	                        	<span class="input-title">报考时间</span>
	                        	<input type="text" class="att-input radius-5px" readonly placeholder="" value="">
	                        	<span class="solid-down-arrow-icon-p">
	                            	<span class="solid-down-arrow-icon bg-cover"></span>
	                        	</span>
	                    	...
	                    	<div class="select radius-5px" id="selectList4">
	                    		<#if scheduleDateData[0]??>
		                        	<#list 0..(scheduleDateData!?size-1) as i>
			                        	<div class="select-list" data-id="${scheduleDateData[i].id}">${scheduleDateData[i].scheduleDate}</div>
			                        </#list>
			                    </#if>
	                    	</div>
	                    </div>
	                    <div class="att-label" id="registerNum">
	                        <span class="input-title">报考登记号</span>
	                        <input type="text" class="att-input radius-5px" placeholder="" value="" maxlength="20">
	                    </div>
	                    <div class="att-label" style="display:none;" id="promptText">
	                    	<div class="color-ff9000 text-left">
	                    		...
	                    		<span class="text-se">请输入完整的报考申请内容，不能有为空项。</span>
	                    	</div>
	                    </div>
	                    <div class="att-label">
    ...
    <script type="text/javascript" src="/resources/compress/js/studycenter/enroll_exam.js"></script>
</body>
</html>
</#compress>