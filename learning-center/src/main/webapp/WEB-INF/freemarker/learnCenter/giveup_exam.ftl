...
<body class="bg-f2">
            	...
            	<div class="attendance-title">
                	<div class="nav" id="nav">
                        <ul>
                            ...
                            <li class="active"><a href="javascript:">弃考</a></li>
	        ...
	        <div class="att-content-bar">
	        	<div class="att-content" style="height:542px">
	                ...
	                <form class="att-form" id="form">
	                    ...
	                    <div class="att-label" id="cause">
	                        <span class="input-title">原因</span>
	                        <textarea rows="4" class="att-textarea radius-5px" placeholder="" maxlength="200"></textarea>
	                    ...
	                    <div class="att-label" style="display:none;" id="promptText">
	                    	<div class="color-ff9000 text-left">
	                    		...
	                    		<span class="text-se">请输入完整的弃考申请内容，不能有为空项。</span>
	                    	</div>
	                    </div>
	                    <div class="att-label">
    ...
    <script type="text/javascript" src="/resources/compress/js/studycenter/giveup_exam.js"></script>
</body>
</html>
</#compress>