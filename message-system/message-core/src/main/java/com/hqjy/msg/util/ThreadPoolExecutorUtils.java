...
public class ThreadPoolExecutorUtils {
    ...
    public  static ThreadPoolExecutor redisExecutor =  new ThreadPoolExecutor(// 自定义一个线程池
            50, // coreSize
            500, // maxSize
            Constant.THREAD_POOL_ALIVE_TIME, // 60s
            TimeUnit.SECONDS, new ArrayBlockingQueue<>(1000)); // 有界队列，容量是3个
    public  static ThreadPoolExecutor mysqlExecutor =  new ThreadPoolExecutor(// 自定义一个线程池
            50, // coreSize
            500, // maxSize
            Constant.THREAD_POOL_ALIVE_TIME, // 60s
            TimeUnit.SECONDS, new ArrayBlockingQueue<>(1000)); // 有界队列，容量是3个
    static {
        ...
        redisExecutor.allowCoreThreadTimeOut(true);
        mysqlExecutor.allowCoreThreadTimeOut(true);
    }
    public  static ThreadPoolExecutor getRedisThreadPoolExecutor(){
