...
public class CourseClassplanLivesChangeRecordEntity implements Serializable {
    ...
    public String toString() {
        return "CourseClassplanLivesChangeRecordEntity{" +
                "classplanLiveId='" + classplanLiveId + '\'' +
                ", classplanId='" + classplanId + '\'' +
                ", classplanLiveName='" + classplanLiveName + '\'' +
                ", classplanLiveTimeDetail='" + classplanLiveTimeDetail + '\'' +
                ", dayTime=" + dayTime +
                ", startTime=" + startTime +
                ", endTime=" + endTime +
                ...
                ", orderNum=" + orderNum +
                ", courseLiveDetailId=" + courseLiveDetailId +
