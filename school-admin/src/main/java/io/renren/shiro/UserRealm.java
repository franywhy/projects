...
/**
 * 认证
 * shiro的BUG http://blog.csdn.net/libraryhu/article/details/50224269
 * @author chenshun
...
//    private SysMenuService sysMenuService;
	...
	private List<SysMenuEntity> queryList(Map<String, Object> map) {
		return sysMenuDao.queryList(map);
	}
	
	private List<String> queryAllPerms(Long userId) {
		return sysUserDao.queryAllPerms(userId);
	}
	
	private SysUserEntity queryByUserName(String username) {
