...
//	        showMeridian: 1
    ...
    $("#jqGrid").jqGrid({//主表数据初始化
        ...
        colModel: [
            ...
            {label: '资料库名', name: 'materialName', width: 80, formatter: materialNameFormatter},
        ...
        getInfoBase: function (classplanId) {
            ...
            $.get("../course/classplan/info/" + classplanId, function (r) {
                if (r.code == 0) {
                    ...
                    //console.log(vm.courseClassplan);
                    //	console.log(r.courseClassplan );
                    //	console.log(r.detailList );
                    vm.courseClassplan = r.courseClassplan;
...
//                url : vm.userplanDetail.url,
        ...
        getMaterialList: function () {
            ...
            $.get("../layerdata/materialList", function (data) {

                vm.materialList = data.data.list;

                $.each(vm.materialList, function (i, v) {

                    vm.materialMap[v.materialId] = v.materialName;
                });
            });
        },
