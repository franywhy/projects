...
public class CourseClassplanLivesEntity implements Serializable {
	...
	public String toString() {
		return "CourseClassplanLivesEntity [classplanLiveId=" + classplanLiveId + ", classplanId=" + classplanId
				...
				+ schoolId + ", courseId=" + courseId + ", dr=" + dr + ", fileUrl=" + fileUrl + ", mId=" + mId
				+ ", backId=" + backId + ", backType=" + backType + ", readyTime=" + readyTime + ", closeTime="
				+ closeTime + ", review=" + review + ", prepare=" + prepare + ", courseware=" + courseware
				+ ", practiceStageId=" + practiceStageId + ", examStageId=" + examStageId + ", phaseName=" + phaseName
