...
import io.renren.modules.job.pojo.log.ClassplanLivePOJO;
...
import io.renren.modules.job.utils.*;
...
//				System.out.println("统计多少天:"+except);
	...
	@Override
	public List<Map<String, Object>> queryListByClassplanId(Object classplanId) {
		
		return this.courseClassplanLivesDao.queryListByClassplanId(classplanId);
	}
}
